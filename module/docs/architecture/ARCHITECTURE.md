...
`VSS_REPOS_DIR=/home/ubuntu/repos`는 repository discovery/UI뿐 아니라 current tracked HEAD의
`POST /index.project_root`에도 사용합니다. 단, immutable Snapshot exact 검증을 먼저 통과해야 하며 historical/inactive Snapshot은 immutable materialized tree를 사용합니다.
