...
VSS ── GET /v1/internal/vss/source|revisions ──────────────┘
 └── Phase 7: refs|context(revision/branch)를 localhost pull
 ↑
Frontend ── /v1/chat
```
...
backend/features/vss_sources/              source/revision?refs/context(revision/branch) + inbound observability
...
alembic/versions/0006*                     historical PR/MR migration; retained for upgrade history
alembic/versions/0007*                     Phase 7A-2 commit catalog migration 완료
alembic/versions/0008*                     historical Tag migration; retained for upgrade history
alembic/versions/0010*                     remove unused Phase 7A tables with empty-table guard
...
| `vss_sources/*` | VSS용 revision/branch refs/context 결정론적 read model 완료 |
