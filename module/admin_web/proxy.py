...
RULES = (
    ...
    RouteRule(re.compile(r"vss/projects/[^/]+/contents"), {"GET": "viewer"}),
    RouteRule(re.compile(r"vss/projects/[^/]+/briefing"), {"GET": "viewer"}),
    RouteRule(re.compile(r"vss/projects/[^/]+/briefing/status"), {"GET": "viewer"}),
